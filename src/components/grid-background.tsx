...
import futureGridImage from "@/src/assets/future-grid.webp";
...
function GridBackground() {
  ...
  return (
    <motion.div
      aria-hidden
      className="pointer-events-none absolute inset-0 -z-50 overflow-hidden bg-primary bg-[size:103%_103%] bg-no-repeat object-fill h-screen"
      style={{
